use suites::suffix_array::impls::SuffixTable;
use suites::suffix_array::interface::SuffixArray;
use actiondb::matcher::compiled_pattern::CompiledPatternBuilder;
use actiondb::parsers::SetParser;
